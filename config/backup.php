...
return [
    ...
    'bingosmash' => [
        'name' => 'bingosmash',
        'host' => env('BINGOSMASH_DB_HOST'),
        'user' => env('BINGOSMASH_DB_USER'),
        'password' => env('BINGOSMASH_DB_PASSWORD'),
        'database' => env('BINGOSMASH_DB_DATABASE', 'bingo_smash_gp'),
        'table' => [
            'users_charge_active',
            'users_room_active',
            'users_rank_score',
